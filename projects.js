...
//   },
...

  {
    ...
    <p>Le sujet portait sur une question ouverte : <em>« Vivre dans une commune plus dense influence-t-il la natalité et la mortalité en Gironde ? »</em>. À partir de données INSEE (densité de population 2022, espérances de vie à la naissance, taux de natalité), nous avons construit une <strong>infographie analytique complète</strong> répondant à cette problématique sur le département le plus grand de France (9 976 km²).</p>
